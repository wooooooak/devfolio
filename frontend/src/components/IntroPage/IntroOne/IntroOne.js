        ...
        <div className={cx('content')}>
          <div className={cx('textBox')}>
            ...
            <p className={cx('text')}>
              ...
              자신을 알려보세요!
              <p>단, 당신의 code를 열람할 수 있는 <a href="https://www.github.com">github</a> 또는 <a href="https://gist.github.com/">gist</a>링크가 필요합니다.</p>
            </p>
            <input type="text" placeholder="닉네임으로 찾기" onChange = {this._onChangeSearch} onKeyPress = {this._onKeyPress} />
            <p onClick = {this._onClickDetailSearch}>자세히 찾아보기</p>
          </div>
